...
int main ()
{
  ...
  unsigned int B_maximo = 0, B_minimo = 99999999;
  unsigned int I_maximo = 0, I_minimo = 99999999;
  for (unsigned int i = 0; i < nPruebas; ++i) {
    ...
    for (unsigned int i = N; i < Banco.size(); i++)
    {
      Tablota.Buscar(Banco[i]);
